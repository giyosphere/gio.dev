      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="md:hidden fixed inset-0 z-50 bg-bg flex flex-col justify-center items-center gap-10"
          >
            <button
              className="absolute top-5 right-6 text-muted hover:text-text transition-colors"
